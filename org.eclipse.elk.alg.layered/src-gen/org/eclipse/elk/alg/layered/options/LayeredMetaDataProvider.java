...
public class LayeredMetaDataProvider implements ILayoutMetaDataProvider {
   ...
   */
  private static final int LAYERING_LAYER_CHOICE_CONSTRAINT_DEFAULT = (-1);
   ...
   */
  private static final int CROSSING_MINIMIZATION_POSITION_CHOICE_CONSTRAINT_DEFAULT = (-1);
